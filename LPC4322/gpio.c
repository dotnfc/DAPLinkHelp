...
// LED0 Green: Running      P2_3: GPIO5[3] (4)
#define LED_CONNECTED_PORT  PORT_LED_RUN
#define LED_CONNECTED_BIT   PORT_LED_RUN_BIT
...
void gpio_init(void)
{
    ...
    scu_pinmux(2,  1, GPIO_PUP,    FUNC4);   /* nRESET:    GPIO5[1] */
    scu_pinmux(1, 20, GPIO_NOPULL, FUNC0);   /* nRESET_OE: GPIO0[15] */
